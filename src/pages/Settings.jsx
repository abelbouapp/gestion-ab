...
import { Btn, Field, Row } from '../components/UI'
    ...
    <div className={s.page}>
      ...
      <section className={s.section}>
        ...
        <form onSubmit={saveInfo} style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            ...
            {saved && <span style={{ color:'var(--brand-dark)', fontSize:13 }}>✓ Guardado correctamente</span>}
          </div>
        </form>
      </section>
      ...
      <section className={s.section}>
        ...
        <form onSubmit={savePwd} style={{ display:'flex', flexDirection:'column', gap:12, maxWidth:380 }}>
          ...
          {pwdMsg && (
            <div style={{ padding:'10px 14px', borderRadius:'var(--radius)', fontSize:13,
